...
const FeaturedProject = ({ type, title, summary, img, link, github }) => {
  return (
    <article className="w-full flex items-center justify-between rounded-3xl border border-solid relative border-dark bg-light shadow-2xl p-12">
...
const Project = ({ type, title, summary, img, link, github }) => {
  return (
    <article className="w-full flex flex-col items-center relative justify-between rounded-3xl border border-solid border-dark bg-light shadow-2xl p-12">
      ...
      <div className=" flex flex-col items-start justify-between mt-2">
        ...
        <div className="w-full mt-2 flex items-center justify-between">
          ...
          <Link
            href={link}
            target="_blank"
            className="underline rounded-lg text-dark p-2 px-6 text-lg font-semibold"
          >
            {" "}
            Visit
          </Link>
